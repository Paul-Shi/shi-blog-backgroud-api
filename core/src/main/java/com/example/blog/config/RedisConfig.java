...
public class RedisConfig {
    ...
    public CacheManager cacheManager() {
        return new RedisCacheManager(
                ...
                //未配置的key默认一周过期
                RedisCacheConfiguration.defaultCacheConfig().entryTtl(Duration.ofDays(7)).serializeValuesWith(RedisSerializationContext.SerializationPair.fromSerializer(new GenericJackson2JsonRedisSerializer())),
