package com.example.blog.common.mq.aspect;

import com.example.blog.common.constants.RabbitMqConstants;
import com.example.blog.common.mq.annotation.RefreshEsMqSender;
...
public class RefreshEsMqAspect {
    ...
    @Pointcut("@annotation(com.example.blog.common.mq.annotation.RefreshEsMqSender)")
